...
//                 if(filterCategory)
//                 {
//                     // Debug.Log(_slot.Value.item.type);
...
//         // if(itemDisplayed[mouseItem.hoverObj].ID >= 0)
//         {
...
//         // if(mouseItem.hoverObj && itemDisplayed[mouseItem.hoverObj] != itemDisplayed[obj])
//         // {
//         //     inventory.MoveItem(itemDisplayed[obj], itemDisplayed[mouseItem.hoverObj], isShiftHeld);
//         // }
...
//         {
//             // Left click action
//             Debug.Log(itemDisplayed[obj].item.Type);
//             if(itemDisplayed[obj].ID >= 0)
//             {
//                 OpenInfoPanel();
...
//     }
//     public void ChangeCategoryType(string typeStr)
//     {
//         ItemType tmp;
//         switch(typeStr)
//         {
//             default:
//                 tmp = ItemType.Default;
//                 break;
//             case "Food":
//                 tmp = ItemType.Food;
//                 break;
//             case "Ingredient":
//                 tmp = ItemType.Ingredient;
//                 break;
//             case "Medicine":
//                 tmp = ItemType.Medicine;
//                 break;
//             case "Tool":
//                 tmp = ItemType.Tool;
//                 break;
